<?php if($seo): ?>
    <meta name="title"
        Content="<?php echo e(@$seoContents['title'] ? $seoContents['title'] : $general->siteName(__($pageTitle))); ?>">
    ...
    <meta name="apple-mobile-web-app-title"
        content="<?php echo e(@$seoContents['title'] ? $seoContents['title'] : $general->siteName($pageTitle)); ?>">
    
    <meta itemprop="name"
        content="<?php echo e(@$seoContents['title'] ? $seoContents['title'] : $general->siteName($pageTitle)); ?>">
    <meta itemprop="description"
        content="<?php echo e(@$seoContents['description'] ? $seoContents['description'] : $general->seo_description); ?>">
    <meta itemprop="image" content="<?php echo e(getImage(getFilePath('seo') . '/' . $seo->image)); ?>">
    
    <meta property="og:type" content="website">
    <meta property="og:title" content="<?php echo e(@$seoContents['title'] ? $seoContents['title'] : $seo->social_title); ?>">
    ...
    <meta property="og:image:type"
        content="image/<?php echo e(pathinfo(getImage(getFilePath('seo')) . '/' . $seo->image)['extension']); ?>" />
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\Files\core\resources\views/partials/seo.blade.php ENDPATH**/ ?>